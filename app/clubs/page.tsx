  ...
  return (
    <Link
      ...
      className="
        ...
        bg-white
        p-5
        shadow-[0_4px_20px_rgba(9,43,95,0.025)]
        transition-all
        duration-200
        hover:-translate-y-1
        hover:border-[#0B3B82]/15
        hover:shadow-[0_16px_40px_rgba(9,43,95,0.08)]
        focus:outline-none
    ...
    >
      ...
      <div className="mt-6 flex-1">
        ...
        >
          {club.short_description ||
            club.description ||
            'A community for students to connect, participate and grow together.'}
        </p>
      </div>
      ...
      >
        ...
        <span
          className="
            ...
            transition-all
            duration-200
            group-hover:border-[#0B3B82]/20
            group-hover:bg-[#0B3B82]
...
function LoadingCard({
  ...
  return (
    ...
    >
      <div
        className="h-14 w-14 animate-pulse rounded-2xl bg-slate-100"
        style={{
...
export default function ClubsPage() {
  ...
  return (
    <main
      className="
        ...
        bg-white
        text-slate-950
        selection:bg-[#F5C542]/30
        selection:text-[#092B5F]
      "
    >
      {/* ======================================================
          NAVIGATION
  ...
  <div className="mx-auto flex h-[68px] max-w-7xl items-center justify-between px-5 sm:px-8">
    ...
    <Link
      href="/"
      className="group flex min-w-0 items-center gap-3 rounded-xl focus:outline-none focus-visible:ring-4 focus-visible:ring-[#0B3B82]/10"
      aria-label="THAARA THEERAM home"
    >
      <div className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-[#0B3B82] shadow-sm transition-transform duration-200 group-hover:scale-[1.03]">
      ...
      <div className="hidden min-w-0 leading-none sm:block">
        <div className="truncate text-[16px] font-extrabold tracking-[-0.02em] text-[#0B3B82]">
          THAARA THEERAM
        </div>
    ...
    <nav className="hidden items-center gap-3 sm:flex">
      ...
      <Link
        href="/clubs"
        aria-current="page"
        className="rounded-lg bg-[#F8FAFD] px-3 py-2 text-sm font-bold text-[#0B3B82] transition-colors duration-200 focus:outline-none focus-visible:ring-4 focus-visible:ring-[#0B3B82]/10"
      >
        Clubs
      </Link>
      ...
      <Link
        href="/start-a-club"
        className="rounded-lg px-3 py-2 text-sm font-semibold text-slate-500 transition-colors duration-200 hover:text-[#0B3B82] focus:outline-none focus-visible:ring-4 focus-visible:ring-[#0B3B82]/10"
      >
        Start a Club
      </Link>
      ...
      {user ? (
        <Link
          href="/dashboard"
          className="ml-2 inline-flex min-h-11 items-center justify-center rounded-xl bg-[#0B3B82] px-5 text-sm font-bold text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#092F6A] hover:shadow-md focus:outline-none focus-visible:ring-4 focus-visible:ring-[#0B3B82]/15"
        >
          Dashboard
        </Link>
      ) : (
    ...
    <div className="flex items-center gap-2 sm:hidden">
      ...
      <Link
        ...
        className="inline-flex min-h-10 items-center justify-center rounded-xl bg-[#0B3B82] px-4 text-sm font-bold text-white shadow-sm transition-colors duration-200 hover:bg-[#092F6A] focus:outline-none focus-visible:ring-4 focus-visible:ring-[#0B3B82]/15"
      >
        ...
        >
          <div className="max-w-4xl">
            ...
            <p
              ...
              "
            >
              Discover the clubs, communities and
              interests that make your college journey
              more meaningful.
            </p>
          </div>
            ...
            <div className="group relative">
              <div
                className="
                  ...
                  transition-colors
                  duration-200
                  group-focus-within:text-[#0B3B82]
                "
              >
              ...
              <input
                ...
                className="
                  ...
                  text-[14px]
                  text-slate-900
                  shadow-[0_8px_30px_rgba(9,43,95,0.04)]
                  outline-none
                  transition-all
                  duration-200
                  placeholder:text-slate-400
                  focus:border-[#0B3B82]/40
                  focus:shadow-[0_12px_36px_rgba(9,43,95,0.08)]
                  focus:ring-4
                  focus:ring-[#0B3B82]/8
                  sm:h-16
                  sm:text-[15px]
            ...
            {loading ? (
              ...
              >
                ...
                <p
                  ...
                  "
                >
                  Try another interest, search
                  term or category. There may be
            ...
            >
              <div className="max-w-2xl">
                ...
                <p
                  ...
                  "
                >
                  Don't see the community you're
                  looking for? Start something
                  meaningful and bring people
                  together around it.
                </p>
              </div>
